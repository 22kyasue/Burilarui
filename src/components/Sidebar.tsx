    ...
    <>
      ...
      >
        ...
        <div className={`p-4 space-y-2 border-b ${theme === 'dark' ? 'border-gray-800' : 'border-gray-100'}`}>
          <button
            onClick={onClose}
            className={`lg:block p-2 rounded-xl w-full flex items-center justify-start transition-colors ${theme === 'dark'
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2.5 rounded-xl transition-colors w-full text-left text-sm font-medium ${theme === 'dark'
              ? 'hover:bg-indigo-900/30 text-gray-300'
              : 'hover:bg-indigo-50 text-gray-700'
              }`}
          >
          ...
          <div>
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="検索"
                className={`w-full border rounded-xl pl-9 pr-3 py-2.5 text-sm placeholder-gray-400 focus:outline-none transition-colors ${theme === 'dark'
          ...
          <div className="px-3 py-3">
            <div className="px-2 py-2 flex items-center justify-between">
              ...
              <button
                ...
                className={`text-xs hover:bg-indigo-50 px-2 py-1 rounded-lg transition-all font-medium cursor-pointer ${theme === 'dark'
        ...
        <div className={`p-3 border-t space-y-1 ${theme === 'dark' ? 'border-gray-800' : 'border-gray-100'}`}>
          <button
            ...
            className={`flex items-center gap-3 px-3 py-2.5 rounded-xl transition-colors w-full text-left group ${theme === 'dark'
              ? 'hover:bg-indigo-900/30'
              : 'hover:bg-indigo-50'
              }`}
          >
            <Settings className={`w-4 h-4 transition-colors ${theme === 'dark'
