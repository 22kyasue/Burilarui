      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-2xl shadow-black/10 max-w-md w-full max-h-[90vh] flex flex-col border border-gray-200/50"
            ...
            <div className="p-6 pb-6 space-y-5 overflow-y-auto flex-1">
              ...
              <div className="space-y-3">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-black text-white rounded-xl hover:bg-gray-900 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow"
                >
